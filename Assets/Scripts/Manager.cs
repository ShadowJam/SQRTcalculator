...
public class Manager : MonoBehaviour {
	...
	void adjustButtons() //функция для объединения кнопок 0
	{
	...
	void updateDigitLabel() //обновление окна с числами 
	{
		if (!errorDisplayed)
	...
	*/
	...
	void calcResult(char activeOp) //операторы
	{
		...
		currentVal = result;
		updateDigitLabel();
		if (currentVal > System.Math.Pow(10, 300))
		{
			errorDisplayed = true;
